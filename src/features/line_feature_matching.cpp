...
#
# Filename:		line_feature_matching.cpp
#
# Description: 
#
===============================================*/
...
//				}
	...
	bool LineFeatureMatching::match(Scan *scan, boost::shared_ptr<pcl::visualization::PCLVisualizer> vis)
	{
...
//					Eigen::Vector3d n=(*it_line).cur->occluded->plane->normal;
...
//					Eigen::Vector3d n=(*it_line).ref->occluded->plane->normal;
