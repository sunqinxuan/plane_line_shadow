...
#
# Last modified:	2019-05-09 20:32
#
# Filename:		line_feature_matching.h
#
# Description: 
#
===============================================*/
...
namespace ulysses
{
	...
	class LineFeatureMatching
	{
	public:

		LineFeatureMatching()
		{
			interp_tree = new InterpTree_Line();
			remove("line_matching.txt");
		}

		LineFeatureMatching(bool v, bool d, double dir, double normal, double dist, double delta_dir, double delta_normal,  double delta_dist)
		{
			debug=d;
			visual=v;
			interp_tree = new InterpTree_Line(d,dir, normal, dist, delta_dir, delta_normal, delta_dist);
			remove("line_matching.txt");
		}

		~LineFeatureMatching() {delete interp_tree;}
